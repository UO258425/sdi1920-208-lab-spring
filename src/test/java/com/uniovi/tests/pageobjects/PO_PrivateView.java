...
public class PO_PrivateView extends PO_NavView {
	...
	public static void addMark(WebDriver driver, int userOrder, String descriptionp, String scorep) {
		...
		PO_PrivateView.fillFormAddMark(driver, userOrder, descriptionp, scorep);
	...
	public static void removeLastMark(WebDriver driver) {
		// Pinchamos en la opción de menu de Notas: //li[contains(@id, 'marks-menu')]/a
		List<WebElement> elementos = PO_View.checkElement(driver, "free", "//li[contains(@id, 'marks-menu')]/a");
		elementos.get(0).click();
